...
<div class="back" on:click={() => isOpen=false}>
	...
	<div class="container mx-auto">
		<div class="text">
			<h1>Найди свой идеальный автомобиль</h1>
			<td width="10%">
	...
	<div class="container mx-auto">
		<h1 id="target-text" class="text">Посетите наших дилеров</h1>
	...
	<div class="container mx-auto">
		<h1 class="text">Почему вы должны покупать у нас</h1>
		<div class="flex gap-5 justify-between">
			<div class="why">
				<div class="txt">
					...
					<p class="text_diler">
						Наш сайт неоднократно оценивался лучшим сайтом по подбору автомобилей
					</p>
				</div>
			</div>
			<div class="why">
